...
export function normalize(o){
 ...
 const name=str(o.name,48),realm=str(o.realm,100),cls=str(o.class,24).toUpperCase();
 if(!name||!realm)throw new Error('Character name and realm are required.');
